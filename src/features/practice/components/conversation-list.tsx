...
const ConversationList = React.memo(function ConversationList({
  ...
  const startEditing = React.useCallback((conversation: Conversation) => {
...
const ConversationRow = React.memo(function ConversationRow({
  ...
  return (
    <Box
      onDoubleClick={() => onStartEditing(conversation)}
      className={cn(
    ...
    >
      ...
      <div className="flex items-center gap-1">
        <IconButton size="small" onClick={() => onStartEditing(conversation)}>
